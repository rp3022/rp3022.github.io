...
**Graduate Research Assistant, New York, USA**	July 2022- present
  ...
  * Conducted a targeted literature review search to identify clinical trials and publications that utilised biomarkers to assess alcohol use with an intervention component
...
**Data Research Analyst Intern**	June-September 2022
  ...
  * Conducted a piecewise regression analysis on the Monitoring The Future (MTF) survey database to analyze trends in marijuana use and risk perceptions among 1,359,169 high school students in the U.S. from 1991-2020.
  * Independently performed end-to-end data management and analysis, including data compilation, coding, statistical analysis, and data visualization using SAS 9.4 and R 4.2.1
